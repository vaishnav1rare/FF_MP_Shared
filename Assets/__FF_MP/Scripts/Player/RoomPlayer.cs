...
{	public enum EGameState
	...
	[Networked] public VehicleController Vehicle { get; set; }
	...
	public override void Spawned()
	{
		...
		if (Object.HasInputAuthority)
		{
			...
			var nickname = GlobalManager.Instance.UIManager.GenerateRandomNickname();
			ClientInfo.Username = nickname;
			GlobalManager.Instance.UIManager.DisableLoadingScreen();
			GlobalManager.Instance.UIManager.OpenLobbyUI();
	...
	public static void RemovePlayer(NetworkRunner runner, PlayerRef p)
	{
		...
		if (roomPlayer != null)
		{
			if (roomPlayer.Vehicle != null)
				runner.Despawn(roomPlayer.Vehicle.Object);
